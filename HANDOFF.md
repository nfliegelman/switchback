...
2. The M0-M10 ladder is COMPLETE at v2.0.0 (2026-07-12). Next major build: the v2.1 web UI per SPEC section 10 and the ROADMAP out-of-scope note. Before that, confirm the owner's three smoke tests (GUI button, GPX import, real Telegram send) happened. Exception rule: pull M9 (watch mode plus Telegram) forward if the owner wants Glacier cancellation alerts now; ELF, COS, ELH are the camps to watch.
