...
3. Map board check: open the board (your home screen icon, or nfliegelman.github.io/switchback/board/). Bottom-left should say v3.6.2; the app caches itself, so give it a close-and-reopen or two. Tap a trip and confirm trail lines draw.
...
Everything now announces itself. The CLI prints "switchback v3.6.2" at the top of every command; the app window title bar shows "Switchback v3.6.2"; the map board shows it bottom-left; the .bat files print it first. If any surface does not say v3.6.2, you are running an old copy: grab the newest zip from the Releases page.
